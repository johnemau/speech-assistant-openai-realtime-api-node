...
/**
 * Place an outbound voice call via Twilio using a webhook URL.
 *
 * @param {object} root0 - Named parameters.
 * @param {string} root0.url - Webhook URL Twilio will request when the call connects.
 ...
 */
export async function placeCall({ url, toNumber, fromNumber, client }) {
    if (IS_DEV) {
